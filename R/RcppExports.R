...
#'
UpdateBeta <- function(p, K, beta_hat, omega_hat, Mu, Sigma, omega) {
    .Call(`_remx_UpdateBeta`, p, K, beta_hat, omega_hat, Mu, Sigma, omega)
}
...
#'
UpdateSigma <- function(eta, K, p, Lambda, beta, Mu) {
    .Call(`_remx_UpdateSigma`, eta, K, p, Lambda, beta, Mu)
}
...
#'
sampler <- function(Niter, Nchain, NburnIn, Nthin, p, q, K, nu, beta, beta_hat, omega_hat, Mu, Sigma, eta, Lambda, xi, TauMu, TauPsi, SigmaPsi, omega, psi, randomModel, fixedModel) {
    .Call(`_remx_sampler`, Niter, Nchain, NburnIn, Nthin, p, q, K, nu, beta, beta_hat, omega_hat, Mu, Sigma, eta, Lambda, xi, TauMu, TauPsi, SigmaPsi, omega, psi, randomModel, fixedModel)
}
...
#'
samplerActor <- function(Niter, Nchain, NburnIn, Nthin, v, u, K, nu, beta, beta_hat, omega_hat, MuB, Sigma, eta, LambdaB, xi, TauMuB, TauPsi, SigmaPsi, omegaB, psi, p, q, gamma, gamma_hat, zeta_hat, MuG, Zeta, LambdaG, TauMuG, TauPhi, SigmaPhi, omegaG, phi, randomModelSnd, randomModelRec, fixModelSnd, fixModelRec) {
    .Call(`_remx_samplerActor`, Niter, Nchain, NburnIn, Nthin, v, u, K, nu, beta, beta_hat, omega_hat, MuB, Sigma, eta, LambdaB, xi, TauMuB, TauPsi, SigmaPsi, omegaB, psi, p, q, gamma, gamma_hat, zeta_hat, MuG, Zeta, LambdaG, TauMuG, TauPhi, SigmaPhi, omegaG, phi, randomModelSnd, randomModelRec, fixModelSnd, fixModelRec)
}
